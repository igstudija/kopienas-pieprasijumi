    ...
    <main className="help-page">
      ...
      <section className="help-detail">
        ...
        <div className="help-facts">
          ...
          <p><b>SMTP credentials</b><span>The wizard encrypts them before storing them in this instance’s Supabase database.</span></p>
      ...
      <section className="help-detail email-help">
        <div><span className="section-number">Email</span><h2>What must be prepared for SMTP?</h2></div>
        <div className="help-facts">
          <p><b>1. Provider account</b><span>Create a Brevo or Mailjet account, or obtain credentials from another SMTP provider.</span></p>
          <p><b>2. Verified sender</b><span>Verify the sender email or domain in the provider dashboard before installation.</span></p>
          <p><b>3. SMTP credentials</b><span>Copy the SMTP login and SMTP key. Do not use your normal account password.</span></p>
          <p><b>4. Delivery test</b><span>The wizard sends a real test email to the first administrator before saving the installation.</span></p>
        </div>
      </section>
    </main>
  );
