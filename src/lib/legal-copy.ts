...
export const legalCopy: Record<Locale, LegalCopy> = {
  lv: {
    ...
    privacy: {
      ...
      accessText: "Profila vārds, uzņēmums, nozare, e-pasts, kontakttālrunis, mājaslapa un publicētā pieprasījuma saturs ir redzams autorizētiem šīs instalācijas biedriem, lai viņi varētu savstarpēji sazināties. Kontakti netiek automātiski nosūtīti savienotām instalācijām. Pieprasījums nonāk savienotā instalācijā tikai tad, ja autors izvēlas atbilstošu kopīgošanas redzamību. Administratoriem ir piekļuve konta pārvaldības datiem. Dati var būt pieejami operatora izvēlētiem hostinga, datubāzes un ziņojumapmaiņas pakalpojumu sniedzējiem to pakalpojuma nodrošināšanai.",
  ...
  en: {
    ...
    privacy: {
      ...
      accessText: "A profile name, company, industry, email, contact phone, website and published request content are visible to authorised members of this installation so that they can contact one another. Contact details are not sent automatically to connected installations. A request reaches a connected installation only when the author selects the corresponding sharing visibility. Administrators can access account-management data. Data may be available to hosting, database and messaging providers selected by the operator where necessary to provide their services.",
  ...
  lt: {
    ...
    privacy: {
      ...
      accessText: "Profilio vardas, įmonė, veiklos sritis, el. paštas, kontaktinis telefonas, svetainė ir paskelbto prašymo turinys matomi autorizuotiems šio diegimo nariams, kad jie galėtų susisiekti tarpusavyje. Kontaktiniai duomenys automatiškai nesiunčiami susietiems diegimams. Prašymas pasiekia susietą diegimą tik autoriui pasirinkus atitinkamą bendrinimo matomumą. Administratoriai turi prieigą prie paskyros valdymo duomenų. Duomenys gali būti prieinami operatoriaus pasirinktiems talpinimo, duomenų bazės ir pranešimų paslaugų teikėjams, kai tai būtina jų paslaugoms.",
  ...
  et: {
    ...
    privacy: {
      ...
      accessText: "Profiilinimi, ettevõte, tegevusala, e-post, kontakttelefon, veebisait ja avaldatud taotluse sisu on nähtavad selle installatsiooni volitatud liikmetele, et nad saaksid üksteisega ühendust võtta. Kontaktandmeid ei saadeta automaatselt ühendatud installatsioonidele. Taotlus jõuab ühendatud installatsiooni ainult siis, kui autor valib vastava jagamisnähtavuse. Administraatoritel on juurdepääs konto haldamise andmetele. Andmed võivad olla kättesaadavad käitaja valitud majutus-, andmebaasi- ja sõnumiteenuse pakkujatele nende teenuse osutamiseks vajalikus ulatuses.",
