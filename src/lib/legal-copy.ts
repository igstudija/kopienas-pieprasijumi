...
export const legalCopy: Record<Locale, LegalCopy> = {
  lv: {
    ...
    impressum: {
      ...
      source: "Pirmkods",
      sourceText: "Pilns projekta pirmkods ir publiski pieejams GitHub. Operators var to pārbaudīt, kopēt, izvietot savā infrastruktūrā un pielāgot.",
      license: "Licence un cena",
      licenseText: "Programmatūra ir pieejama bez maksas ar MIT licenci. Tā atļauj lietošanu, kopēšanu, modificēšanu, apvienošanu, publicēšanu, izplatīšanu, sublicencēšanu un pārdošanu, saglabājot licences un autortiesību paziņojumu.",
      warranty: "Garantija",
  ...
  en: {
    ...
    impressum: {
      ...
      source: "Source code",
      sourceText: "The complete project source code is publicly available on GitHub. An operator may inspect, copy, deploy on its own infrastructure and adapt it.",
      license: "Licence and price",
      licenseText: "The software is available free of charge under the MIT License. It permits use, copying, modification, merging, publication, distribution, sublicensing and sale, provided the copyright and licence notices are retained.",
      warranty: "Warranty",
  ...
  lt: {
    ...
    impressum: {
      ...
      sourceText: "Visas projekto pirminis kodas viešai prieinamas „GitHub“. Operatorius gali jį patikrinti, kopijuoti, diegti savo infrastruktūroje ir pritaikyti.",
      license: "Licencija ir kaina",
      licenseText: "Programinė įranga nemokamai teikiama pagal MIT licenciją. Ji leidžia naudoti, kopijuoti, keisti, jungti, skelbti, platinti, sublicencijuoti ir parduoti, išsaugant autorių teisių ir licencijos pranešimus.",
      warranty: "Garantija",
  ...
  et: {
    ...
    impressum: {
      ...
      source: "Lähtekood",
      sourceText: "Projekti täielik lähtekood on avalikult kättesaadav GitHubis. Käitaja võib seda kontrollida, kopeerida, oma taristus juurutada ja kohandada.",
      license: "Litsents ja hind",
      licenseText: "Tarkvara on tasuta saadaval MIT-litsentsi alusel. See lubab kasutamist, kopeerimist, muutmist, ühendamist, avaldamist, levitamist, all-litsentsimist ja müüki, kui autoriõiguse ja litsentsi teated säilitatakse.",
      warranty: "Garantii",
