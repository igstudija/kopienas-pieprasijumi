...
For large or risky work, write a short execution plan using `docs/EXECUTION-PLAN.md`. Use `docs/CODE_REVIEW.md` before requesting review and `docs/DEVELOPMENT.md` for the full workflow.
